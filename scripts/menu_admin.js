...
function agregarItemAlCarrito(titulo, precio, imagenSrc) {
    ...
    var itemsCarrito = document.getElementsByClassName('box')[0];
...
function actualizarTotalCarrito() {
    ...
    var carritoItems = carritoContenedor.getElementsByClassName('box');
    var total = 0;
...
function pagarClicked() {
    ...
    var carritoItems = document.getElementsByClassName('box')[0];
